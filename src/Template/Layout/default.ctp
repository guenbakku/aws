...
<head>
    <?= $this->Html->charset() ?>
    <title>AWS Resources Manager</title>
...
<body>
    ...
    <?= $this->Html->script("{$plugin}.jquery-2.2.4.min.js") ?>
    <?= $this->Html->script("{$plugin}./packages/bootstrap/js/bootstrap.min.js") ?>
    <?= $this->Html->script("{$plugin}./packages/bootstrap-material-design-master/js/material.min.js") ?>
    <?= $this->Html->script("{$plugin}./packages/bootstrap-material-design-master/js/ripples.min.js") ?>
